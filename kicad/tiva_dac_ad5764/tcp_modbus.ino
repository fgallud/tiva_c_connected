/*
Para enviar comandos se puede usar esto desde python
...
#define TIMEOUT 1000  //timeout de la conexion en milisegundos
#define DEBUG true
...
void setup() {
  Serial.begin(115200);  
  delay(1000);  
  Serial.println("canal debug inicializado");
...
void loop() {
  ...
  } //no ha detectado un cliente serie. un else aqui podria tratar tareas que puedan ser interrumpidas por 
